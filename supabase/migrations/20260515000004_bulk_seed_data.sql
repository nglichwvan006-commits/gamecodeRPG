...
('Is Number Even?', 'Return true if the number is even, false otherwise.', 'Easy', 5, 30, 'Math', '["basics"]', '[{"input": [4], "expected": true}, {"input": [7], "expected": false}]', 'function isEven(n) {\n  // Write your code here\n}'),
('Count Vowels', 'Count the number of vowels (a, e, i, o, u) in a string.', 'Easy', 15, 60, 'Strings', '["strings"]', '[{"input": ["hello"], "expected": 2}, {"input": ["programming"], "expected": 3}]', 'function countVowels(str) {\n  // Write your code here\n}'),
('Calculate Factorial', 'Return the factorial of a non-negative integer n.', 'Easy', 15, 75, 'Math', '["recursion", "math"]', '[{"input": [5], "expected": 120}, {"input": [0], "expected": 1}]', 'function factorial(n) {\n  // Write your code here\n}'),
('Remove Duplicates', 'Remove duplicate elements from an array.', 'Easy', 20, 100, 'Arrays', '["arrays", "sets"]', '[{"input": [[1, 2, 2, 3, 1]], "expected": [1, 2, 3]}]', 'function removeDuplicates(arr) {\n  // Write your code here\n}'),
('Sum of N Numbers', 'Return the sum of integers from 1 to n.', 'Easy', 10, 50, 'Math', '["math"]', '[{"input": [10], "expected": 55}]', 'function sumN(n) {\n  // Write your code here\n}'),
('Array Average', 'Calculate the average value of elements in an array.', 'Easy', 10, 50, 'Arrays', '["arrays"]', '[{"input": [[1, 2, 3, 4, 5]], "expected": 3}]', 'function average(arr) {\n  // Write your code here\n}'),
('Find Minimum', 'Find the smallest number in an array.', 'Easy', 10, 50, 'Arrays', '["arrays"]', '[{"input": [[10, 20, 5, 30]], "expected": 5}]', 'function findMin(arr) {\n  // Write your code here\n}'),
('Length of Last Word', 'Find the length of the last word in a string.', 'Easy', 15, 60, 'Strings', '["strings"]', '[{"input": ["Hello World"], "expected": 5}, {"input": ["   fly me   to   the moon  "], "expected": 4}]', 'function lengthOfLastWord(s) {\n  // Write your code here\n}'),
('Check Leap Year', 'Return true if the year is a leap year.', 'Easy', 15, 60, 'Math', '["logic"]', '[{"input": [2000], "expected": true}, {"input": [1900], "expected": false}]', 'function isLeapYear(year) {\n  // Write your code here\n}'),
('Celsius to Fahrenheit', 'Convert temperature from Celsius to Fahrenheit.', 'Easy', 10, 50, 'Math', '["conversions"]', '[{"input": [0], "expected": 32}, {"input": [100], "expected": 212}]', 'function cToF(c) {\n  // Write your code here\n}'),
('Find Index of Element', 'Return the index of a value in an array or -1 if not found.', 'Easy', 10, 50, 'Arrays', '["arrays"]', '[{"input": [[1, 2, 3], 2], "expected": 1}]', 'function findIndex(arr, val) {\n  // Write your code here\n}'),
('Concatenate Strings', 'Join two strings with a space.', 'Easy', 5, 20, 'Strings', '["basics"]', '[{"input": ["Hello", "World"], "expected": "Hello World"}]', 'function joinStrings(s1, s2) {\n  // Write your code here\n}'),
('Capitalize First Letter', 'Capitalize the first letter of a string.', 'Easy', 10, 50, 'Strings', '["strings"]', '[{"input": ["javascript"], "expected": "Javascript"}]', 'function capitalize(s) {\n  // Write your code here\n}'),
('Power of Two', 'Check if a number is a power of two.', 'Easy', 20, 80, 'Math', '["bit-manipulation"]', '[{"input": [16], "expected": true}, {"input": [18], "expected": false}]', 'function isPowerOfTwo(n) {\n  // Write your code here\n}'),
('Reverse Array', 'Reverse the elements of an array in place or return new.', 'Easy', 10, 50, 'Arrays', '["arrays"]', '[{"input": [[1, 2, 3]], "expected": [3, 2, 1]}]', 'function reverseArray(arr) {\n  // Write your code here\n}'),
('Count Occurrences', 'Count how many times a character appears in a string.', 'Easy', 15, 60, 'Strings', '["strings"]', '[{"input": ["mississippi", "s"], "expected": 4}]', 'function countChar(s, char) {\n  // Write your code here\n}'),
-- Adding more to reach 50
('Repeat String', 'Repeat a string n times.', 'Easy', 10, 50, 'Strings', '[]', '[{"input": ["abc", 3], "expected": "abcabcabc"}]', 'function repeat(s, n) {}'),
('Truncate String', 'Truncate a string if it is longer than n.', 'Easy', 10, 50, 'Strings', '[]', '[{"input": ["hello world", 5], "expected": "hello..."}]', 'function truncate(s, n) {}'),
('Find Longest Word', 'Find the longest word in a sentence.', 'Easy', 15, 75, 'Strings', '[]', '[{"input": ["The quick brown fox"], "expected": "quick"}]', 'function longestWord(s) {}'),
('Validate Email', 'Simple regex check for email format.', 'Easy', 20, 100, 'Regex', '[]', '[{"input": ["test@test.com"], "expected": true}]', 'function validateEmail(e) {}'),
('Merge Arrays', 'Combine two arrays and remove duplicates.', 'Easy', 20, 100, 'Arrays', '[]', '[{"input": [[1,2], [2,3]], "expected": [1,2,3]}]', 'function merge(a, b) {}'),
('Get Array Intersection', 'Find common elements between two arrays.', 'Easy', 20, 100, 'Arrays', '[]', '[{"input": [[1,2,3], [2,3,4]], "expected": [2,3]}]', 'function intersect(a, b) {}'),
('Binary to Decimal', 'Convert binary string to decimal number.', 'Easy', 20, 100, 'Math', '[]', '[{"input": ["1010"], "expected": 10}]', 'function bToD(b) {}'),
('Decimal to Binary', 'Convert decimal number to binary string.', 'Easy', 20, 100, 'Math', '[]', '[{"input": [10], "expected": "1010"}]', 'function dToB(d) {}'),
('Is Anagram', 'Check if two strings are anagrams.', 'Easy', 20, 100, 'Strings', '[]', '[{"input": ["listen", "silent"], "expected": true}]', 'function isAnagram(a, b) {}'),
('Filter Odd Numbers', 'Remove even numbers from an array.', 'Easy', 10, 50, 'Arrays', '[]', '[{"input": [[1,2,3,4]], "expected": [1,3]}]', 'function filterOdd(arr) {}'),
('Flatten Array', 'Flatten a 2D array into 1D.', 'Easy', 20, 100, 'Arrays', '[]', '[{"input": [[[1,2], [3,4]]], "expected": [1,2,3,4]}]', 'function flatten(arr) {}'),
('Chunk Array', 'Split an array into chunks of size n.', 'Easy', 25, 120, 'Arrays', '[]', '[{"input": [[1,2,3,4], 2], "expected": [[1,2], [3,4]]}]', 'function chunk(arr, size) {}'),
('Title Case', 'Convert string to Title Case.', 'Easy', 15, 75, 'Strings', '[]', '[{"input": ["i am a coder"], "expected": "I Am A Coder"}]', 'function titleCase(s) {}'),
('Random Integer', 'Generate a random integer between min and max.', 'Easy', 10, 50, 'Math', '[]', '[{"input": [1, 1], "expected": 1}]', 'function randomInt(min, max) {}'),
('GCD of Two Numbers', 'Find the greatest common divisor.', 'Easy', 20, 100, 'Math', '[]', '[{"input": [8, 12], "expected": 4}]', 'function gcd(a, b) {}'),
('LCM of Two Numbers', 'Find the least common multiple.', 'Easy', 20, 100, 'Math', '[]', '[{"input": [4, 6], "expected": 12}]', 'function lcm(a, b) {}'),
('Fibonacci Iterative', 'Return nth Fibonacci number without recursion.', 'Easy', 15, 75, 'Math', '[]', '[{"input": [6], "expected": 8}]', 'function fib(n) {}'),
('Prime Checker', 'Check if a number is prime.', 'Easy', 20, 100, 'Math', '[]', '[{"input": [13], "expected": true}]', 'function isPrime(n) {}'),
('Get Prime Factors', 'Return prime factors of a number.', 'Easy', 25, 125, 'Math', '[]', '[{"input": [12], "expected": [2, 2, 3]}]', 'function primeFactors(n) {}'),
('Matrix Transpose', 'Transpose a 2x2 matrix.', 'Easy', 25, 125, 'Math', '[]', '[{"input": [[[1,2],[3,4]]], "expected": [[1,3],[2,4]]}]', 'function transpose(m) {}'),
('Rotate Array', 'Rotate array to the right by k steps.', 'Easy', 20, 100, 'Arrays', '[]', '[{"input": [[1,2,3], 1], "expected": [3,1,2]}]', 'function rotate(arr, k) {}'),
('Sum Digits', 'Sum all digits of a number.', 'Easy', 15, 75, 'Math', '[]', '[{"input": [123], "expected": 6}]', 'function sumDigits(n) {}'),
('Count Words', 'Count number of words in a string.', 'Easy', 10, 50, 'Strings', '[]', '[{"input": ["Hello world"], "expected": 2}]', 'function countWords(s) {}'),
('Check Subset', 'Check if array A is a subset of B.', 'Easy', 20, 100, 'Arrays', '[]', '[{"input": [[1,2], [1,2,3]], "expected": true}]', 'function isSubset(a, b) {}'),
('Unique Values', 'Return unique values using Set.', 'Easy', 10, 50, 'Arrays', '[]', '[{"input": [[1,1,2]], "expected": [1,2]}]', 'function unique(arr) {}'),
('Valid Bracket Start', 'Check if string starts with ( and ends with ).', 'Easy', 10, 50, 'Logic', '[]', '[{"input": ["(hello)"], "expected": true}]', 'function valid(s) {}'),
('Sort Array', 'Sort an array of numbers.', 'Easy', 10, 50, 'Arrays', '[]', '[{"input": [[3,1,2]], "expected": [1,2,3]}]', 'function sortArr(arr) {}'),
('Find Duplicates', 'Return array of duplicate values.', 'Easy', 20, 100, 'Arrays', '[]', '[{"input": [[1,2,2,3,3]], "expected": [2,3]}]', 'function getDupes(arr) {}'),
('Missing Number', 'Find the missing number in 1-n range.', 'Easy', 20, 100, 'Math', '[]', '[{"input": [[1,2,4,5]], "expected": 3}]', 'function missing(arr) {}'),
('Last Element', 'Return the last element of an array.', 'Easy', 5, 20, 'Arrays', '[]', '[{"input": [[1,2,3]], "expected": 3}]', 'function last(arr) {}');
